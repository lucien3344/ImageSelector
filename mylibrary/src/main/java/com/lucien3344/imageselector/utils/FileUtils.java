...
public class FileUtils {
    ...
    public static String createDir(String dirPath) {
        try {
            ...
            if (file.getParentFile().exists()) {
                DebugUtil.i("----- 创建文件夹" + file.getAbsolutePath());
                file.mkdir();
    ...
    public static String createFile(File file) {
        try {
            if (file.getParentFile().exists()) {
                DebugUtil.i("----- 创建文件" + file.getAbsolutePath());
                file.createNewFile();
                return file.getAbsolutePath();
            } else {
                createDir(file.getParentFile().getAbsolutePath());
    ...
    public static Uri getImageContentUri(Activity activity, File imageFile) {
        ...
        Cursor cursor = activity.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, new String[]{MediaStore.Images.Media._ID}, MediaStore.Images.Media.DATA + "=? ",
    ...
    public static String getApplicationId(Context appContext) throws IllegalArgumentException {
        ...
        try {
            ...
            DebugUtil.d(appContext.getPackageName() + " " + applicationInfo.metaData.getString("APP_ID"));
