...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mMutateBackground) {
            ...
            // so it's false by default, what doesn't allow to create the RoundDrawable. At this point, after load
            // mMutateBackground and updated BackgroundDrawable to RoundDrawable, the View's background drawable needs to
